...
const removeUserFromLocalStorage=()=>{
    ...
    return (<AppContext.Provider value={{...state,displayAlert,registerUser,loginUser,setupUser,toggleSidebar,logoutUser,updateUser,handleChange,clearValues,createJob,getJobs,setEditJob,deleteJob,editJob,showStats,clearFilters,changePage,users,getAllUsers,getAllQuizes,quizId,getAllQuizId,questions,setQuestions,refresh,setRefresh,quizzes,setQuizzes,getFlag,flag,setFlag,correct,setCorrect}}>
    {children}
    </AppContext.Provider>
)
}
